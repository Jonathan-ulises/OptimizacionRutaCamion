...
public class ForegroundService extends Service {
    ...
    public static String START_ACTION = "com.example.pruebanavegacion.fs.action.start";
    public static String STOP_ACTION = "com.example.pruebanavegacion.fs.action.stop";
    ...
    public void initChannels(Context context) {
        ...
        NotificationChannel channel = new NotificationChannel(CHANNEL, "Foreground channel", NotificationManager.IMPORTANCE_DEFAULT);
